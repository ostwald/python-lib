...
class DcsInstanceLinks:
	...
	def getLink (self, instance, link):
		...
		return DIV (Href (url, link, target="dcs"), klass="link")
	...
	def renderHtml (self, html_out_dir):
		template = open (os.path.join (html_out_dir, "InstancesTemplate.html"), 'r').read()
	...
	def updatePage (self, html_out_dir):
		...
		out_path = os.path.join (html_out_dir, "DCS-links.html")
		f = open (out_path, 'w')
		f.write (html)
		f.close ()
...
if __name__ == "__main__":
	...
	html_out_dir = "/Users/ostwald/Desktop/DCSLinkTool/old/"
