"""
We are provided with a CSV report from the Explorer. Our job is to create a similar
spreadsheet containing only pubs with the first author from the reporting group.
